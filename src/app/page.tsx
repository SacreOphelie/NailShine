  ...
  const {data: avis, error: errorAvis} = await supabase
    ...
    <>
      <div className="slide" id="accueil">
          <div className="container wrapper">
            <div className="left">
              ...
              <Image src="/images/illustrations/Noeud.png" alt="Noeud" id="noeud" className="illu" width={100} height={100} />
              <Image src="/images/illustrations/Vernis.png" alt="Vernis" id="vernis" className="illu" width={100} height={100} />
            </div>
            <div className="right">
              <h1>Prothésiste ongulaire
                <Image src="/images/illustrations/etoile.png" alt="Étoile" id="etoile" className="illu" width={100} height={100} />
              </h1>
              <div className="container-info">
                <div className="info">
                  <Image src="/icones/location.png" alt="Localisation" id="location" width={100} height={100} />
                  <p className="bolder"><strong>{adresse}</strong></p>
                </div>
                <div className="info">
                  <Image src="/icones/diplome.png" alt="Diplôme" id="diplome" width={100} height={100} />
      ...
      <div id="top-techniques">
        ...
        <Image src="/images/illustrations/Rond.png" alt="Rond" id="rond2_technique" className="illu illu_petit" width={100} height={100} />
      ...
      <div className="slide" id="techniques">
        ...
        <div id="bottom-techniques">
          <Image src="/images/illustrations/etoile.png" alt="Rond" id="etoile1_technique" className="illu illu_grand" width={100} height={100} />
          <Image src="/images/illustrations/etoile.png" alt="Rond" id="etoile2_technique" className="illu illu_petit" width={100} height={100} />
          <svg viewBox="0 0 1919 238.09" xmlns="http://www.w3.org/2000/svg">
            <path d="M1919,60.89v177.19H0V0c106.64,21.77,213.21,44.72,321.24,59.33,169.38,22.91,340.04,24.01,510.82,25.01,87.5.51,175.4,1.39,262.89,0,224.18-3.57,447.68-29.44,671.87-35.9,40.33-1.16,88.72-3.94,128.29,3.13,8.13,1.45,18.01,3.29,23.9,9.33Z"/>
          </svg>
        </div>
