  ...
  if (error) {
    ...
    <>
      ...
      <div id="top-techniques">
        <img src="/images/illustrations/Rond.png" alt="Rond" id="rond1_technique" className="illu illu_grand"/>
        <img src="/images/illustrations/Rond.png" alt="Rond" id="rond2_technique" className="illu illu_petit"/>
      ...
      <div className="slide" id="techniques">
        ...
        <div id="bottom-techniques">
          <img src="/images/illustrations/etoile.png" alt="Rond" id="etoile1_technique" className="illu illu_grand"/>
          <img src="/images/illustrations/etoile.png" alt="Rond" id="etoile2_technique" className="illu illu_petit"/>
          <svg viewBox="0 0 1919 238.09" xmlns="http://www.w3.org/2000/svg">
            <path d="M1919,60.89v177.19H0V0c106.64,21.77,213.21,44.72,321.24,59.33,169.38,22.91,340.04,24.01,510.82,25.01,87.5.51,175.4,1.39,262.89,0,224.18-3.57,447.68-29.44,671.87-35.9,40.33-1.16,88.72-3.94,128.29,3.13,8.13,1.45,18.01,3.29,23.9,9.33Z"/>
          </svg>
        </div>
